...
$sql="SELECT * FROM docentes where documento='$documento'";
...
<div class="container">
  <div class="row">
    ...
    <div class="col">
          ...
          <h1 class="text-center">Actualizacion De Datos Del Docente</h1>
          <br>
        <!--formulario-->
        <form  action="updatedoce.php" method="get">
          ...
          <br>
            ...
            <input type="text" class="form-control" name = "nombre" id="nombre" placeholder="Ingrese su Correo Electronico" value = "<?php echo $row['nombre'] ?>">
          
          <br>
         
            <label for="inputCity" class="form-label">Numero de Telefono</label>
            <input type="number" class="form-control" name = "numero" id="numero" placeholder="Ingrese el curso en el que se quiere registrar" value = "<?php echo $row['numero'] ?>">
          
          <br>
            
              <label for="inputEmail4" class="form-label">Correo</label>
              <input type="text" class="form-control" name = "correo" id="correo"  placeholder="Ingrese su Nombre" value = "<?php echo $row['correo'] ?>">
            
            <br>
            
              <label for="inputPassword4" class="form-label">Programa</label>
              <input type="text" class="form-control" name = "programa" id="programa" placeholder="Ingrese su Apellido" value = "<?php echo $row['programa'] ?>">
